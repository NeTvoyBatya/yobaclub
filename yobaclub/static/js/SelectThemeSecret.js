...
var checkMarks = {
    ...
    "secret": document.getElementById('SecretCheckMark')
}
var phoneCheckMarks = {
    ...
    "secret": document.getElementById('SecretCheckMarkPhone')
}
...
function setTheme(themeName){
    for(var key in checkMarks){
        ...
        if (key == themeName){
            ...
            if (themeName == 'secret'){
                document.getElementById("YobaLogo").setAttribute('src', document.getElementById("YobaLogo").getAttribute('src').replace('YobaLogo.png', 'YobaSecretLogo.png'))
            }
        }else{
